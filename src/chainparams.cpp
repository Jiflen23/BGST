...
// Copyright (c) 2015-2017 The PIVX Developers, The stotinka Developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000019902c682d58511ecc40b78303f927e50f706cd2e66c9e89e0e185c7ba58"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1610629148, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x0000693077d334e31d834d3b9edec836622c4cc272a380a6a533c1df42c7663d"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 39260;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // stotinka starting difficulty is 1 / 2^12
	...
	nNewMasternodeCollateral_GPBlock = 20; // 1 week grace period to allow for masternodes to activate using the new collateral
        nNewMasternode_Collateral = 600;
        nOriginalMasternode_Collateral = 600;
        ...
        const char* pszTimestamp = "stotinka (BGST) new coin bulgarian jan 14 2021.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1610629148;
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 78336;
        ...
        nStartMasternodePayments = 1610629148;
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1610629181;
        genesis.nNonce = 71144;
        

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000693077d334e31d834d3b9edec836622c4cc272a380a6a533c1df42c7663d"));
        assert(genesis.hashMerkleRoot == uint256("0x478158b98fa18b040ce958b2a1cc3487e1b89f15439aeef4851f74478e4d6bef"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 125); // Testnet stotinka addresses start with 'P'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 126);  // Testnet stotinka script addresses start with 'M'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 184);     // Testnet private keys start with 2
        // Testnet stotinka BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet stotinka BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet stotinka BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // BGST: 1 day
        nTargetSpacing = 1 * 60;        // BGST: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1610629215;
