...
// Copyright (c) 2021 The BGST developers
...
#if defined(NDEBUG)
#error "STOTINKA cannot be compiled without assertions."
#endif
...
{
    RenameThread("stotinka-scriptch");
...
bool CheckWork(const CBlock block, CBlockIndex* const pindexPrev)
{
	...
	uiInterface.ThreadSafeMessageBox(_("You are on the wrong chain.  Please check debug.log for more information on resolving this.  Shutting down."), "", CClientUIInterface::MSG_ERROR);
        LogPrintf("Your block database is from a forked version of the correct chain.  Please visit https://github.com/BGSTCoin/bootstrap to avoid any potential loss of future rewards and get on the proper chain.\n");
        StartShutdown();
        return false;
      }
    }
