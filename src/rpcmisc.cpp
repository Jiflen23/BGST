...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total stotinka balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized stotinka balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in stotinka/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in stotinka/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"stotinkaaddress\"\n"
            "\nReturn information about the given stotinka address.\n"
            "\nArguments:\n"
            "1. \"stotinkaaddress\"     (string, required) The stotinka address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"stotinkaaddress\", (string) The stotinka address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: STOTINKA address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are stotinka addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) stotinka address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"stotinkaaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"stotinkaaddress\"  (string, required) The stotinka address to use for the signature.\n"
