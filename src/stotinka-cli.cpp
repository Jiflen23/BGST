...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("BGST RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  stotinka-cli [options] <command> [params]  " + _("Send command to BGST") + "\n" +
                        "  stotinka-cli [options] help                " + _("List commands") + "\n" +
                        "  stotinka-cli [options] help <command>      " + _("Get help for a command") + "\n";
