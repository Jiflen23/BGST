/* src/config/stotinka-config.h.  Generated from stotinka-config.h.in by configure.  */
/* src/config/stotinka-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BGST_CONFIG_H

#define BGST_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bgstcoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BGST Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BGST Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "stotinka"
