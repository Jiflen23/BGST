...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BGST stotinka-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stotinka-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stotinka transaction") + "\n" +
                               "  stotinka-tx [options] -create [commands]   " + _("Create hex-encoded stotinka transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stotinka transaction
