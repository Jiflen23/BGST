...
// Copyright (c) 2020 The BGST developers
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STOTINKA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stotinka: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BGST"), this);
    aboutAction->setStatusTip(tr("Show information about BGST"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for STOTINKA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STOTINKA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STOTINKA addresses"));
    ...
    openAction->setStatusTip(tr("Open a STOTINKA: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BGST help message to get a list with possible STOTINKA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BGST client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STOTINKA network", "", count));
}
...
{
    QString strTitle = tr("BGST"); // default title
