...
/** Utility functions used by the STOTINKA Qt UI.
 */
namespace GUIUtil
{
...
// Render STOTINKA addresses in monospace font
...
// Parse "stotinka:" URI into recipient object, return true on successful parsing
