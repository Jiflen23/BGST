...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop STOTINKA server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "STOTINKA server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BGST features */
        {"stotinka", "masternode", &masternode, true, true, false},
        {"stotinka", "listmasternodes", &listmasternodes, true, true, false},
        {"stotinka", "getmasternodecount", &getmasternodecount, true, true, false},
        {"stotinka", "masternodeconnect", &masternodeconnect, true, true, false},
        {"stotinka", "masternodecurrent", &masternodecurrent, true, true, false},
        {"stotinka", "masternodedebug", &masternodedebug, true, true, false},
        {"stotinka", "startmasternode", &startmasternode, true, true, false},
        {"stotinka", "createmasternodekey", &createmasternodekey, true, true, false},
        {"stotinka", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"stotinka", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"stotinka", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"stotinka", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"stotinka", "getmasternodescores", &getmasternodescores, true, true, false},
        {"stotinka", "mnbudget", &mnbudget, true, true, false},
        {"stotinka", "preparebudget", &preparebudget, true, true, false},
        {"stotinka", "submitbudget", &submitbudget, true, true, false},
        {"stotinka", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"stotinka", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"stotinka", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"stotinka", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"stotinka", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"stotinka", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"stotinka", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stotinka", "checkbudgets", &checkbudgets, true, true, false},
        {"stotinka", "mnsync", &mnsync, true, true, false},
        {"stotinka", "spork", &spork, true, true, false},
        {"stotinka", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"stotinka", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use stotinkad, or the -server option to stotinka-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"STOTINKA Alert\" admin@foo.com\n"),
...
{
    return "> stotinka-cli " + methodname + " " + args + "\n";
}
