...
In order to support loading of multiple wallets in stotinka-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stotinka.cpp.
...
Changes to stotinka.cpp
----------------------
stotinka.cpp is the entry point into stotinka-qt, and as such, will require some minor modifications to provide hooks for
