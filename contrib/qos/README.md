...
This means one can have an always-on stotinkad instance running, and another local stotinkad/stotinka-qt instance which connects to this node and receives blocks from it.
