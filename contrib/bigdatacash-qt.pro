...
RESOURCES += src/qt/stotinka.qrc src/qt/stotinka_locale.qrc

TRANSLATIONS += src/qt/locale/stotinka_bg.ts \
                src/qt/locale/stotinka_de.ts \
                src/qt/locale/stotinka_en.ts \
                src/qt/locale/stotinka_es.ts \
                src/qt/locale/stotinka_fi.ts \
                src/qt/locale/stotinka_fr.ts \
                src/qt/locale/stotinka_it.ts \
                src/qt/locale/stotinka_ja.ts \
                src/qt/locale/stotinka_pl.ts \
                src/qt/locale/stotinka_pt.ts \
                src/qt/locale/stotinka_ru.ts \
                src/qt/locale/stotinka_sk.ts \
                src/qt/locale/stotinka_sv.ts \
                src/qt/locale/stotinka_vi.ts \
                src/qt/locale/stotinka_zh_CN.ts \
                src/qt/locale/stotinka_zh_TW.ts
